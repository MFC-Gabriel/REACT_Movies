import { CardContent, CardItem, CardList } from "./styles";
...
export function List({ category }) {
  ...
  // qualquer mudança no estado tipo o use effect vai ser ativado
  return (
